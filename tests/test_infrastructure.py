...
class TestIntegratedJobExecution:
    ...
    def test_job_database_isolation(self, tmp_molq_home):
        ...
        submitter1.register_job(
            "test1", 1001, "job1", JobStatus.Status.RUNNING,
            "echo test1", str(tmp_molq_home), 1234567890
        )
        
        submitter2.register_job(
            "test2", 2001, "job2", JobStatus.Status.PENDING,
            "echo test2", str(tmp_molq_home), 1234567890
        )
