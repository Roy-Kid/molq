...
class TestCleanupTempFiles:
    ...
    def test_explicit_cleanup_enabled(self, isolated_temp_dir, cleanup_after_test):
        ...
        assert not script_path.exists(), "Script should be cleaned up when explicitly enabled"
    ...
    def test_compute_resource_spec_cleanup(self):
        ...
        assert not script_path.exists(), "ComputeResourceSpec should also support cleanup"
    ...
    def test_backwards_compatibility_dict_config(self):
        ...
        assert script_path.exists(), "Dict config should respect cleanup_temp_files=False"
